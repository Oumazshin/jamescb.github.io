          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 px-4 transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
            {githubUrl && (
              <a 
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 bg-transparent border-2 border-[#212842] text-[#212842] hover:bg-[#212842] hover:text-[#F0E7D5] rounded-lg font-medium transition-all duration-300 text-center text-sm hover:scale-110 hover:shadow-lg hover:shadow-blue-500/30 active:scale-95"
              >
            ...
            {liveUrl && liveUrl !== "#" && (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-4 py-2 bg-[#212842] hover:bg-[#212842]/90 text-[#F0E7D5] rounded-lg font-medium transition-all duration-300 text-center text-sm hover:scale-110 hover:shadow-lg hover:shadow-blue-500/30 active:scale-95"
              >
